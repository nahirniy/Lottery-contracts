...
const config: any = {
  ...
  networks: {
    hardhat: {
      ...
      chainId: 31337,
      forking: {
        url: process.env.ETH_MAINNET_URL || 'https://polygon.llamarpc.com',
    ...
    tenderly: {
      url: 'https://rpc.vnet.tenderly.co/devnet/deployment/f6767c02-5614-4421-88d4-622b956b4ad3',
      chainId: 11155111.,
    },
    localhost: {
    ...
    arbitrumSepolia: {
      ...
      accounts:
        process.env.PRIVATE_KEY !== undefined ? [process.env.PRIVATE_KEY, "0xecaf4563b86d695a61c64d3989aa72538a1eb9f337bf653c84dbb72ee509fea8"] : [],
    },
    arbitrumMain: {
  ...
  xdeploy: {
    ...
    // networks: ['hardhat', 'mumbai', 'bscTestnet'],
    // networks: ['sepolia', 'bscTestnet', 'auroraTestnet'],
    networks: ['hardhat'],
